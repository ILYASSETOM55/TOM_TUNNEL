...
echo -e "${LN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${NC}"
echo -e "${LN}┃${NC} ${BG}           INSTALLATION DE TOM BOT            ${NC} ${LN}┃${NC}"
echo -e "${LN}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${NC}"
echo -e ""
...
echo -e "${GR}[+] Téléchargement complet du moteur TOM C2 (Fichiers + Modules)...${NC}"
cd /tmp
rm -rf repo_temp
...
[Unit]
Description=Tom Bot Telegram C2
...
systemctl enable --now tom_tunnel_bot
