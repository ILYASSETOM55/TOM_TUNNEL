#!/bin/bash
clear
# Variables de couleurs du TOM_TUNNEL
LN='\e[36m'
NC='\e[0m'
BG='\e[44m'
RD='\e[31m'
...
echo -e "${RD}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${NC}"
echo -e "${RD}┃${NC} ${WH}       DÉSINSTALLATION TOTALE : TOM_TUNNEL      ${NC} ${RD}┃${NC}"
echo -e "${RD}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${NC}"
echo -e ""
...
systemctl stop xray zivpn tom_tunnel_bot dropbear stunnel4 ws-dropbear ws-stunnel >/dev/null 2>&1
systemctl disable xray zivpn tom_tunnel_bot dropbear stunnel4 ws-dropbear ws-stunnel >/dev/null 2>&1
sleep 1
echo -e "${GR}[ OK ]${NC}"

echo -ne " ${WH}▪ Éradication des bases de données...${NC}"
rm -rf /etc/xray /etc/zivpn /etc/slowdns /etc/tom_tunnel_bot /root/tom_tunnel_bot_engine /root/tom_tunnel_core_bot
rm -f /etc/systemd/system/tom_tunnel_bot.service
sleep 1
echo -e "${GR}[ OK ]${NC}"
